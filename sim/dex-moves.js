...
var DataMove = /** @class */ (function (_super) {
    ...
    function DataMove(data) {
        ...
        _this.type = utils_1.Utils.getString(data.type);
        ...
        _this.baseMoveType = utils_1.Utils.getString(data.baseMoveType) || _this.type;
        ...
        _this.noPPBoosts = !!((_a = data.noPPBoosts) !== null && _a !== void 0 ? _a : data.isZ);
        ...
        if (_this.category !== 'Status' && !data.maxMove && _this.id !== 'struggle') {
        ...
        if (_this.category !== 'Status' && !data.zMove && !_this.isZ && !_this.isMax && _this.id !== 'struggle') {
...
var EMPTY_MOVE = utils_1.Utils.deepFreeze(new DataMove({ name: '', exists: false }));
var DexMoves = /** @class */ (function () {
    ...
    DexMoves.prototype.get = function (name) {
        if (name && typeof name !== 'string')
            return name;
        var id = name ? (0, dex_data_1.toID)(name.trim()) : '';
        ...
        if (id && this.dex.data.Moves.hasOwnProperty(id)) {
            ...
            if (this.dex.parentMod) {
                ...
                if (moveData === parentMod.data.Moves[id]) {
                    var parentMove = parentMod.moves.getByID(id);
