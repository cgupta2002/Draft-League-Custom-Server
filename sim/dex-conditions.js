...
var Condition = /** @class */ (function (_super) {
    ...
    function Condition(data) {
        ...
        _this.effectType = (['Weather', 'Status', 'Terrain'].includes(data.effectType) ? data.effectType : 'Condition');
...
var EMPTY_CONDITION = utils_1.Utils.deepFreeze(new Condition({ name: '', exists: false }));
